...
public class FarmerController : Controller
{
    ...
    public async Task<ActionResult<FarmerVm>> HomePage( CancellationToken cancellationToken)
    {
        var enti = await _services.GetAllAsync(cancellationToken);
        return View(enti);

    }


    public async Task<ActionResult<FarmerVm>> AboutPage(CancellationToken cancellationToken)
    {
        var enti = await _services.GetAllAsync(cancellationToken);
        return View(enti);
    ...
    public async Task<ActionResult<FarmerVm>>ContactPage(CancellationToken cancellationToken)
    {
        var enti = await _services.GetAllAsync(cancellationToken);
        return View(enti);
    }
    ...
    public async Task<ActionResult<FarmerVm>> HomeDetails(CancellationToken cancellationToken)
    {
        var enti = await _services.GetAllAsync(cancellationToken);
        return View(enti);
    }
